...
@section('content')
    ...
    <div x-data="{}">
                ...
                <table class="w-full min-w-max">
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            <th style="background-color: #124731; color: #FFFFFF;" class="px-3 py-3 text-left sm:px-6 first:rounded-tl-xl sticky-left-header">
                                <p class="font-semibold text-white text-theme-xs truncate">Codigo</p>
                            </th>
                            <th style="background-color: #124731; color: #FFFFFF;" class="px-5 py-3 text-left sm:px-6">
                            ...
                            <th style="background-color: #124731; color: #FFFFFF;" class="px-5 py-3 text-right sm:px-6 last:rounded-tr-xl">
        ...
        <x-ui.modal
            x-data="{
                open: false,
                taxRateData: { id: '', code: '', description: '', tax_rate: '', order_num: '', status: true }
            }"
            @open-edit-tax-rate-modal.window="taxRateData = $event.detail; open = true"
        ...
        >
            <div class="p-6 sm:p-8">
                ...
                <form method="POST" :action="`{{ url('/admin/herramientas/tasas-impuesto') }}/${taxRateData.id}{{ $viewId ? '?view_id=' . $viewId : '' }}`" class="space-y-6">
                    @csrf
                    @method('PUT')
                    @if ($viewId)
                        <input type="hidden" name="view_id" value="{{ $viewId }}">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                name="description"
                                x-model="taxRateData.description"
                                required
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <input
                                    ...
                                    name="status"
                                    value="1"
                                    x-model="taxRateData.status"
                                    class="h-4 w-4 rounded border-gray-300 text-[#124731] focus:ring-brand-500 dark:border-gray-600 dark:bg-gray-800"
                                />
