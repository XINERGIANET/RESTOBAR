                                    ...
                                    <div class="flex items-center justify-center">
                                        ...
                                        >
                                            ...
                                            <x-ui.button
                                                ...
                                                variant="primary"
                                                type="submit"
                                                className="{{ $permission->status ? 'bg-[#124731] text-white hover:bg-[#0A2E1F]' : 'bg-gray-500 text-white hover:bg-gray-600' }} ring-0 rounded-full"
                ...
                >
                    ...
                    <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
                        <input
                            type="checkbox"
                            data-select-all
                            class="h-4 w-4 rounded border-gray-300 text-[#124731] focus:ring-brand-500"
                                        ...
                                        @foreach ($module->menuOptions as $option)
                                            <label class="flex items-start gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 shadow-sm transition hover:border-brand-300 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-200">
                                                <input
                                                    ...
                                                    value="{{ $option->id }}"
                                                    data-select-item
                                                    class="mt-1 h-4 w-4 rounded border-gray-300 text-[#124731] focus:ring-brand-500"
