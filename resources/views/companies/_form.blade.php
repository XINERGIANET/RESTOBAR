<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="md:col-span-1">
        ...
        <div class="relative group">
            <span class="absolute top-1/2 left-0 -translate-y-1/2 border-r border-gray-200 px-4 py-2 text-gray-400 transition-colors group-focus-within:text-[#124731] dark:border-gray-800">
            ...
            <input
                ...
                class="dark:bg-dark-900 shadow-theme-xs focus:border-[#124731] focus:ring-[#124731]/10 h-12 w-full rounded-xl border border-gray-300 bg-transparent px-4 py-2.5 pl-[68px] text-sm text-gray-800 placeholder:text-gray-400 focus:ring-4 focus:outline-hidden dark:border-gray-700 dark:text-white/90 dark:placeholder:text-white/30"
            />
        </div>
        @error('tax_id')
