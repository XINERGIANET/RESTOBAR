                    ...
                    <table class="w-full min-w-[880px]">
                        <thead>
                            <tr class="border-b border-gray-100 dark:border-gray-800 text-white">
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6 first:rounded-tl-xl sticky-left-header"><p class="font-medium text-white text-theme-xs dark:text-white">ID</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6"><p class="font-medium text-white text-theme-xs dark:text-white">Icono</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6"><p class="font-medium text-white text-theme-xs dark:text-white">Nombre</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6"><p class="font-medium text-white text-theme-xs dark:text-white">Tipo</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6"><p class="font-medium text-white text-theme-xs dark:text-white">Acción</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6"><p class="font-medium text-white text-theme-xs dark:text-white">Estado</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-right sm:px-6 last:rounded-tr-xl text-white"><p class="font-medium text-white text-theme-xs dark:text-white">Acciones</p></th>
                            </tr>
                        </thead>
                        <tbody>
