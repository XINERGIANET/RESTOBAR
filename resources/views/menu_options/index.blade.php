        ...
        >
            ...
            <div class="table-responsive mt-4 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <table class="w-full min-w-max">
                        <thead>
                            <tr class="text-white">
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6 first:rounded-tl-xl sticky-left-header"><p class="font-semibold text-gray-100 text-theme-xs uppercase">Orden (ID)</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6"><p class="font-semibold text-gray-100 text-theme-xs uppercase">Icono</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6"><p class="font-semibold text-gray-100 text-theme-xs uppercase">Nombre</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6"><p class="font-semibold text-gray-100 text-theme-xs uppercase">Ruta / Acción</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-left sm:px-6"><p class="font-semibold text-gray-100 text-theme-xs uppercase">Estado</p></th>
                                <th style="background-color: #124731;" class="px-5 py-3 text-right sm:px-6 last:rounded-tr-xl"><p class="font-semibold text-gray-100 text-theme-xs uppercase">Acciones</p></th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr class="border-b border-gray-100 transition hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-white/5">
                                    ...
                                    <td class="px-5 py-4 sm:px-6">
                                        ...
                                        @if($option->quick_access)
                                            <span class="mt-1 inline-block text-[10px] text-[#124731] bg-[#124731]/10 px-1 rounded border border-brand-100">Acceso Rápido</span>
                                        @endif
                                    </td>
                                    <td class="px-5 py-4 sm:px-6">
