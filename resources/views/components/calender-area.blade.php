            ...
            <div class="flex flex-col px-2 overflow-y-auto modal-content custom-scrollbar">
                ...
                <div class="mt-8 modal-body">
                    ...
                    <div>
                        ...
                        <input id="event-title" type="text" class="dark:bg-dark-900 shadow-theme-xs focus:border-[#124731] focus:ring-[#124731]/10 dark:focus:border-[#124731] h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" placeholder="Enter event title" />
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative">
                            <input id="event-start-date" type="date" class="dark:bg-dark-900 shadow-theme-xs focus:border-[#124731] focus:ring-[#124731]/10 dark:focus:border-[#124731] h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" onclick="this.showPicker()" />
                ...
                <div class="flex items-center gap-3 mt-6 modal-footer sm:justify-end">
                    ...
                    <button type="button" class="btn btn-update-event bg-[#124731] hover:bg-[#0A2E1F] flex w-full justify-center rounded-lg px-4 py-2.5 text-sm font-medium text-white sm:w-auto" style="display: none;" data-fc-event-public-id="">
                        Update Changes
                    </button>
                    <button type="button" class="btn btn-add-event bg-[#124731] hover:bg-[#0A2E1F] flex w-full justify-center rounded-lg px-4 py-2.5 text-sm font-medium text-white sm:w-auto">
                        Add Event
                    </button>
                </div>
