...
class OrderPriceEditingParameterSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $parameter = Parameters::query()->updateOrCreate(
            ['description' => 'Permitir editar precios en pedidos'],
            ['value' => 'No', 'parameter_category_id' => $category->id, 'status' => 1]
        );
